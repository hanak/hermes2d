...
int main(int argc, char* argv[])
{
  ...
  do
  {
    ...
    double err_est = hp.calc_error(Tuple<Solution*>(&x_sln_coarse, &y_sln_coarse), Tuple<Solution*>(&x_sln_fine, &y_sln_fine)) * 100;
...
#define ERROR_FAILURE      -1
  ...
  if (ndof <= ndof_allowed) {      // ndofs was 784 at the time this test was created
    printf("Success!\n");
