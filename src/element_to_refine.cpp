...
HERMES2D_API std::istream& operator>>(std::istream& stream, const TagChecker& checker) {
  stringstream tag;
...
HERMES2D_API ElementToRefineStream& operator<<(ElementToRefineStream& stream, const std::vector<ElementToRefine>& elem_refs) {
...
HERMES2D_API ElementToRefineStream& operator>>(ElementToRefineStream& stream, std::vector<ElementToRefine>& elem_refs) {
