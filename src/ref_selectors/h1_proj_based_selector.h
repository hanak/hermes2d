...
namespace RefinementSelectors {
   ...
   *  loop. */
  class H2D_API H1ProjBasedSelector : public ProjBasedSelector {
  public: //API
    /// Constructor.
  ...
  protected: //overloads
    ...
    const static int H2DRS_MAX_H1_ORDER = H2DRS_MAX_ORDER; ///< A maximum used order in this H1-space selector.
