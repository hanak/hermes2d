...
HERMES2D_API bool is_refin_aniso(const int refin_type) {
...
HERMES2D_API int get_refin_sons(const int refin_type) {
  switch(refin_type) {
...
HERMES2D_API const std::string get_refin_str(const int refin_type) {
  switch(refin_type) {
